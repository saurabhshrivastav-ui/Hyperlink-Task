    ...
    >
      ...
      <View style={styles.heroContainer}>
        ...
        <View style={styles.infoCardsRow}>
          ...
          <View style={styles.infoCard}>
            <Feather name="clock" size={25} color="#7C3AED" />
            <Text style={styles.infoValue} weight="700">
              2 min
            </Text>
            <Text style={styles.infoLabel} weight="400">
...
const styles = StyleSheet.create({
  ...
  heroSafe: {
    backgroundColor: "#f7fafc", // keeps safe area consistent
  },
  ...
  warningBadge: {
    ...
    marginTop: 10,
    backgroundColor: "rgba(85,63,181,0.08)",
    borderWidth: 1,
    borderColor: "rgba(85,63,181,0.16)",
    paddingVertical: 8,
  ...
  illustration: { width: width * 0.6, height: 210 },
  infoCardsRow: {
    flexDirection: "row",
  ...
  infoValue: { fontSize: 22, color: "#1F2937" },
  infoLabel: { fontSize: 18, color: "#6B7280" },
  ...
  profileTagText: { fontSize: 13, color: "#7C3AED" },
  dropdownIcon: {
    padding: 8,
