        ...
        <View style={styles.pagePadding}>
              ...
              <View style={styles.resultRow}>
                ...
                <View style={styles.resultTextContainer}>
                  ...
                  <Text style={styles.resultDesc} weight="500">
                    This result suggests that your current symptom pattern and
                    risk factors may require closer attention and timely action.
                  </Text>
                  <Text style={styles.resultDesc2} weight="500">
                    This does not confirm a diagnosis, but it does indicate that
                    getting clinical guidance can help prevent complications and
                    provide clarity.
                  </Text>
                </View>
              </View>
          ...
          >
            ...
            <Text style={styles.researchText} weight="400">
              Clinical research and global health guidelines highlight that
              early evaluation and timely intervention improve outcomes and
              reduce long-term complications when high-risk indicators are
              present.
            </Text>
            <Pressable style={({ hovered }) => [hovered && styles.linkHover]}>
...
const styles = StyleSheet.create({
  container: {
    flex: 1,
    backgroundColor: "#f7fafc" /* warmer off-white */,
  },
  header: {
    flexDirection: "row",
    alignItems: "center",
