      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        >
          ...
          <Text style={styles.headerSubtitle}>
            Your health indicators are within a safe range
          </Text>
          ...
          <View style={styles.resultCard}>
            <Text style={styles.resultCardText}>
              Based on your responses, you are currently at a low risk.
              Continue maintaining a healthy lifestyle to stay on track.
            </Text>
          </View>
        </LinearGradient>
